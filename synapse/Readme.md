...
Sample scripts to create Azure Synapse Analytics environment as shown in the following architecture diagram. The scripts are mix of ARM Templates and few powershell scripts because everything is not available using ARM Templates at this time. Also, please note some of the preview features are used as well.

<img src="./images/AzureSynapseEnvironment.JPG" alt="Architecture Diagram" width="100%" height="100%">

**Note**: Please refer to my medium post [**XXXXX**](https://medium.com/@isinghrana/XxXXX) to get better context on the reasoning behind this architecture.
